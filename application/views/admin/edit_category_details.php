...
$(document).ready(function() {	
	...
	messages: {
	   category: {
			required: "<td><div class='error-left'></div><div class='error-inner'>The category field is required.</div></td>"
		},
		description: {
			required: "<td><div class='error-left'></div><div class='error-inner'>The description field is required.</div></td>",
		},
		status: {
			required:"<td><div class='error-left'></div><div class='error-inner'>The is_active field is required.</div></td>"	
		}
	} 
...
<tr>
	...
	<td>
		...
		<!-- start id-form -->
		 <form name="manage_record" method="post" action="<?php echo ($category_id) ? "admin/edit_category/$category_id" : "admin/edit_category";?>" id="manage_record">
		...
		<tr>
			...
			<td><input type="text" class="inp-form" name="description"  id="description" value="<?php if(isset($row) && !empty($row->description)) { echo $row->description ; } ?>" /></td>
			<td>
