...
function deleteuser(flag) {
	var delete_url="admin/deleteinvestor/"+isvid;	
	if(flag=='yes' && isvid!='') {
...
<div id="content">
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('company ',record_list);" title="Click to arrange in ascending/descending order."><strong >  Company Name </strong></a>	</th>
                    ...
                    <th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('email1',record_list);" title="Click to arrange in ascending/descending order."><strong > Email </strong></a></th>
				...
				<tr class="<?php echo $class; ?>">
					<td><?php echo $i;?></td>
					<td title="<?php $name=$row->company ;?>"><?php echo stripslashes($this->utility->limit_char($row->company,100));?></td>
					...
					<td title="<?php $joining_date=$row->project_type ;?>"><?php echo stripslashes($this->utility->limit_char($row->project_type,100));?></td>
				
                
					<td title="<?php $joining_date=$row->email1 ;?>"><?php echo stripslashes($this->utility->limit_char($row->email1,100));?></td>	 
					<td class="options-width">
                    <span id="st<?php echo $row->id;?>" title="click to change status."> <?php if($row->status==1){?> <img src="public/admin/images/ico4.png" style="cursor:pointer;" border="0" onclick="change_status(<?php echo $row->id;?>,'deactivate','investor_registration');"><?php } else { ?> <img src="public/admin/images/ico5.png" style="cursor:pointer;" border="0" onclick="change_status(<?php echo $row->id;?>,'activate','investor_registration');"> <?php }?></span>
				...
				?>
			  <tr>
                <td colspan="7" align="center" height="50"><b>Sorry, no records found for this query.</b></td>
              </tr>
              <?php } ?>     
	...
	<div id="popupContact">
		...
		<p class="txt14">
			Are you sure you want to delete this investor?</p>
