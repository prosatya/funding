...
function deleteuser(flag) {
	var delete_url="admin/deletecontact/"+cid;	
	if(flag=='yes' && cid!='') {
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<!--  start product-table ..................................................................................... -->
				 <form name="record_list" method="post" action="admin/contactus_details" id="record_list">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('cname ',record_list);" title="Click to arrange in ascending/descending order."><strong >  Name </strong></a>	</th>
					<th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('cmail',record_list);" title="Click to arrange in ascending/descending order."><strong > E-mail </strong></a></th>
					<th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('contactno',record_list);" title="Click to arrange in ascending/descending order."><strong > Contact Number </strong></a></th>
					<th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('ipaddress',record_list);" title="Click to arrange in ascending/descending order."><strong > IP Address </strong></a></th>
				...
				<tr class="<?php echo $class; ?>">
					<td><?php echo $i;?></td>
					<td title="<?php $name=$row->cname ;?>"><?php echo stripslashes($this->utility->limit_char($row->cname,100));?></td>
					<td title="<?php $user_email=$row->cmail ;?>"><?php echo stripslashes($this->utility->limit_char($row->cmail,100));?></td>
					<td title="<?php $status=$row->contactno ;?>"><?php echo stripslashes($this->utility->limit_char(ucwords($row->contactno),100));?></td>
					<td title="<?php $joining_date=$row->ipaddress ;?>"><?php echo stripslashes($this->utility->limit_char($row->ipaddress,100));?></td>
					 
					<td class="options-width">
                    
					<span><a href="admin/contact_view/<?php echo $row->id; ?>" title="View Contact us profile details."><img src="public/admin/images/view.png"/></a></span>
                    
                       <span><a class="button" title="Delete contact us profile."><img src="public/admin/images/ico7.png" width="15" height="15" hspace="5" vspace="2" align="absmiddle" onclick="scrollup('<?php echo $row->id; ?>')"/></a></span>
				...
				?>
			  <tr>
                <td colspan="6" align="center" height="50"><b>Sorry, no records found for this query.</b></td>
              </tr>
              <?php } ?>     
