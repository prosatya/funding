...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td><?php if(isset($row->page_name)) { echo $row->page_name ; } ?></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Page Title:</th>
			<td><?php if(isset($row->page_title)) { echo $row->page_title ; } ?></td>
			 
		</tr>
		<tr>
		<th valign="top">Page Keywords:</th>
		<td><?php if(isset($row->page_keywords)) { echo $row->page_keywords ; } ?>
		</td>
		<td></td>
		</tr>
		...
		<td><?php if($row->page_heading ) { echo $row->page_heading ;  }    ?>
		</td>
		<td></td>
		</tr>
		<tr>
		<th valign="top"> Description:</th>
		<td><?php echo $row->page_desc ; ?>
		</td>
		<td></td>
		</tr> 
		<tr>
			<th valign="top">Status:</th>
			<td><?php if($row->status==1) { echo 'Active'; }  if($row->status==0) { echo 'Deactive'; } ?></td>
			<td></td>
		</tr>
	...
	<tr>
		<th>&nbsp;</th>
		<td valign="top">
        <form method="post" action="admin/edit_page/<?php echo $row->id ; ?>">
