...
?>
		 <form name="manage_record" method="post" action="admin/sendmail" id="manage_record">
        <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		
        <tr>
			<th valign="top">Event URL:</th>
			<td>  <strong><?php echo $room_data->room_url; ?></strong></td>
			<td></td>
		</tr>
        ...
        <tr>
			...
			<td> <select name="user[]" id="name" multiple="multiple"  size="5" >
            ...
            <?php } ?>
         </select><br>Press CTRL key to Multiple select</td>
			<td></td>
		</tr>
