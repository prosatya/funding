...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td><?php if(isset($row->room_type)) { echo $row->room_type ; } ?></td>
			 
		</tr>
		 
        <tr>
		<th valign="top">Event Date:</th>
		<td><?php $str1=str_replace('T0',' ',$row->starts_at);
							$dateString1 = $str1;
							$dateObject1 = new DateTime($dateString1);
							$start1= $dateObject1->format('Y-m-d h:i A');
							
							$str11=str_replace('T0',' ',$row->ends_at);
							$dateString11 = $str11;
        ...
        <tr>
		<th valign="top"> Room URL:</th>
		<td><?php echo $row->room_url ; ?>
		</td>
		<td></td>
		</tr> 
	...
	<tr>
		<th>&nbsp;</th>
		<td valign="top">
        <form method="post" action="admin/edit_event/<?php echo $row->id ; ?>">
