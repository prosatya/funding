...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td><?php if(isset($row->slug)) { echo $row->slug ; } ?></td>
			 
		</tr>
		<tr>
		<th valign="top">Description:</th>
		<td><?php if(isset($row->description)) { echo $row->description ; } ?>
		</td>
		<td></td>
		</tr>
		...
		<td><?php if($row->user_name ) { echo $row->user_name ;  }    ?>
		</td>
		<td></td>
		</tr>
		<tr>
	...
	<tr>
		<th>&nbsp;</th>
		<td valign="top">
        <form method="post" action="admin/edit_project/<?php echo $row->id ; ?>">
