...
function deletecategory(flag) {
	var delete_url="admin/deletecategory/"+categoryid;	
	if(flag=='yes' && categoryid!='') {
...
<div id="content">
	...
	<div id="page-heading">
		<h1>Manage Category</h1>
         <span style="float:right;margin-right:30px;font-size:18px;font-weight:bold;"><a href="admin/add_category" style="color:#000;">Add New Category</a></span>
	</div>
	<!-- end page-heading -->
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<!--  start product-table ..................................................................................... -->
				 <form name="record_list" method="post" action="admin/category_details" id="record_list">
                  <input type="hidden" name="orderby" value="<?php if(isset($orderby)) echo $orderby; else echo 'id'; ?>" />
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('category_name ',record_list);" title="Click to arrange in ascending/descending order."><strong >  Name </strong></a>	</th>
					<th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('Description',record_list);" title="Click to arrange in ascending/descending order."><strong > Description </strong></a></th>
				...
				<tr class="<?php echo $class; ?>">
					<td><?php echo $i;?></td>
					<td title="<?php $name=$row->category_name ;?>"><?php echo stripslashes($this->utility->limit_char($row->category_name,100));?></td>
					<td title="<?php $description=$row->description ;?>"><?php echo stripslashes($this->utility->limit_char($row->category_name,100));?></td>
							
					 
					<td class="options-width">
                    <span id="st<?php echo $row->id;?>" title="click to change status."> <?php if($row->status==1){?> <img src="public/admin/images/ico4.png" style="cursor:pointer;" border="0" onclick="change_status(<?php echo $row->id;?>,'deactivate','category');"><?php } else { ?> <img src="public/admin/images/ico5.png" style="cursor:pointer;" border="0" onclick="change_status(<?php echo $row->id;?>,'activate','category');"> <?php }?></span>
					<span><a href="admin/view_category/<?php echo $row->id; ?>" title="View category profile details."><img src="public/admin/images/view.png"/></a></span>
                    <span><a href="admin/edit_category/<?php echo $row->id; ?>" title="Click to edit category."><img src="public/admin/images/ico3.png"/></a></span>
                       <span><a class="button" title="Delete category."><img src="public/admin/images/ico7.png" width="15" height="15" hspace="5" vspace="2" align="absmiddle" onclick="scrollup('<?php echo $row->id; ?>')"/></a></span>
			  ...
			  <tr>
                <td colspan="4" align="center" height="50">
					<b>Sorry, no records found for this query.</b>
				</td>
              </tr>
              <?php } ?>     
	...
	<div id="popupContact">
		...
		<div style="width:330px; text-align:center; padding-top: 32px;"><a onclick="deletecategory('yes');" class="" id="popupContactClose"><img src="public/admin/images/yes_btn.png" border="0" /></a>
		<a onclick="deletecategory('no');" id="popupContactClose"><img src="public/admin/images/no_btn.png" border="0" /></a>
