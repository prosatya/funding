...
function deleteuser(flag) {
	var delete_url="admin/deletecompany/"+cid;	
	if(flag=='yes' && cid!='') {
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<!--  start product-table ..................................................................................... -->
				 <form name="record_list" method="post" action="admin/company_details" id="record_list">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('company_name ',record_list);" title="Click to arrange in ascending/descending order."><strong >  Company Name </strong></a>	</th>
					<th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('first_name',record_list);" title="Click to arrange in ascending/descending order."><strong >First Name </strong></a></th>
					<th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('last_name',record_list);" title="Click to arrange in ascending/descending order."><strong > Last Name </strong></a></th>
					<th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('type',record_list);" title="Click to arrange in ascending/descending order."><strong > Type </strong></a></th>
                    
                    <th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('city',record_list);" title="Click to arrange in ascending/descending order."><strong > City </strong></a></th>
				...
				<tr class="<?php echo $class; ?>">
					<td><?php echo $i;?></td>
					<td title="<?php $name=$row->company_name ;?>"><?php echo stripslashes($this->utility->limit_char($row->company_name,100));?></td>
					<td title="<?php $user_email=$row->first_name ;?>"><?php echo stripslashes($this->utility->limit_char($row->first_name,100));?></td>
					<td title="<?php $status=$row->last_name ;?>"><?php echo stripslashes($this->utility->limit_char(ucwords($row->last_name),100));?></td>
					<td title="<?php $joining_date=$row->type ;?>"><?php echo stripslashes($this->utility->limit_char($row->type,100));?></td>
				
                
					<td title="<?php $joining_date=$row->city ;?>"><?php echo stripslashes($this->utility->limit_char($row->city,100));?></td>	 
					<td class="options-width">
                    <span id="st<?php echo $row->id;?>" title="click to change status."> <?php if($row->status==1){?> <img src="public/admin/images/ico4.png" style="cursor:pointer;" border="0" onclick="change_status(<?php echo $row->id;?>,'deactivate','company_registration');"><?php } else { ?> <img src="public/admin/images/ico5.png" style="cursor:pointer;" border="0" onclick="change_status(<?php echo $row->id;?>,'activate','company_registration');"> <?php }?></span>
					<span><a href="admin/company_view/<?php echo $row->id; ?>" title="View user profile details."><img src="public/admin/images/view.png"/></a></span>
                    <span><a href="admin/edit_company/<?php echo $row->id; ?>" title="Click to edit user."><img src="public/admin/images/ico3.png"/></a></span>
                       <span><a class="button" title="Delete user profile."><img src="public/admin/images/ico7.png" width="15" height="15" hspace="5" vspace="2" align="absmiddle" onclick="scrollup('<?php echo $row->id; ?>')"/></a></span>
                       
                       <span id="pub<?php echo $row->id;?>" title="click to change publish."> <?php if($row->is_feature==1){?> <img src="public/admin/images/yes.png" style="cursor:pointer;" border="0" onclick="change_publish(<?php echo $row->id;?>,'deactivate','company_registration');"><?php } else { ?> <img src="public/admin/images/no.png" style="cursor:pointer;" border="0" onclick="change_publish(<?php echo $row->id;?>,'activate','company_registration');"> <?php }?></span>
