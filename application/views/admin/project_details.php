...
function deleteuser(flag) {
	var delete_url="admin/deleteproject/"+pid;	
	if(flag=='yes' && pid!='') {
...
<div id="content">
	...
	<div id="page-heading">
		<h1>Manage Project</h1>
         <span style="float:right;margin-right:30px;font-size:18px;font-weight:bold;"><a href="admin/add_project" style="color:#000;">Add New Project</a></span>
	</div>
	<!-- end page-heading -->
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<!--  start product-table ..................................................................................... -->
				 <form name="record_list" method="post" action="admin/project_details" id="record_list">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('title ',record_list);" title="Click to arrange in ascending/descending order."><strong >  Title </strong></a>	</th>
					<th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('slug',record_list);" title="Click to arrange in ascending/descending order."><strong > Slug </strong></a></th>
					<th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('author',record_list);" title="Click to arrange in ascending/descending order."><strong > Author </strong></a></th>
					<th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('date',record_list);" title="Click to arrange in ascending/descending order."><strong > Date </strong></a></th>
				...
				<tr class="<?php echo $class; ?>">
					<td><?php echo $i;?></td>
					<td title="<?php $name=$row->title ;?>"><?php echo stripslashes($this->utility->limit_char($row->title,100));?></td>
					<td title="<?php $user_email=$row->slug ;?>"><?php echo stripslashes($this->utility->limit_char($row->slug,100));?></td>
					<td title="<?php
					   
					 if($row->user_name) { $user=$row->user_name ; }?>"><?php echo stripslashes($this->utility->limit_char(ucwords($user),100));?></td>
					<td title="<?php $joining_date=$row->date ;?>"><?php echo stripslashes($this->utility->limit_char($row->date,100));?></td>
					 
					<td class="options-width">
                    <span id="st<?php echo $row->id;?>" title="click to change status."> <?php if($row->status==1){?> <img src="public/admin/images/ico4.png" style="cursor:pointer;" border="0" onclick="change_status(<?php echo $row->id;?>,'deactivate','projects');"><?php } else { ?> <img src="public/admin/images/ico5.png" style="cursor:pointer;" border="0" onclick="change_status(<?php echo $row->id;?>,'activate','projects');"> <?php }?></span>
					<span><a href="admin/view_project/<?php echo $row->id; ?>" title="View project profile details."><img src="public/admin/images/view.png"/></a></span>
                    <span><a href="admin/edit_project/<?php echo $row->id; ?>" title="Click to edit project."><img src="public/admin/images/ico3.png"/></a></span>
