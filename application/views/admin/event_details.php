...
function deleteuser(flag) {
	var delete_url="admin/delete_event/"+eid;	
	if(flag=='yes' && eid!='') {
...
<div id="content">
	...
	<div id="page-heading">
		<h1>Manage Event</h1>
        <span style="float:right;margin-right:30px;font-size:18px;font-weight:bold;"><a href="admin/add_event" style="color:#000;">Add New Event</a></span>
	</div>
	<!-- end page-heading -->
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<!--  start product-table ..................................................................................... -->
				 <form name="record_list" method="post" action="admin/event_view" id="record_list">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('name ',record_list);" title="Click to arrange in ascending/descending order."><strong >  Event Name </strong></a>	</th>
					<th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('starts_at',record_list);" title="Click to arrange in ascending/descending order."><strong > Event Date Time </strong></a></th>
                    
                    <th class="table-header-repeat line-left minwidth-1"><a style="cursor:pointer; color:#FFFFFF;" onclick="fun_orderby('room_url',record_list);" title="Click to arrange in ascending/descending order."><strong > Event URL </strong></a></th>
				...
				<tr class="<?php echo $class; ?>">
					<td><?php echo $i;?></td>
                    <td title="<?php $name=$meeting->name ;?>"><?php echo stripslashes($this->utility->limit_char($meeting->name,100));?></td>
					<td title="<?php 
						$str=str_replace('T0',' ',$meeting->starts_at);
							...
							$event=  $start.'-'.$end; ?>"><?php echo stripslashes($this->utility->limit_char($event,100));?></td>
					
			<td title="<?php $room_url=$meeting->room_url ;?>"><?php echo stripslashes($this->utility->limit_char($meeting->room_url,100));?></td>		 
					 
					<td class="options-width">
                   <!-- <span id="st<?php #echo $meeting->id;?>" title="click to change status."> <?php #if($meeting->status==1){?> <img src="public/admin/images/ico4.png" style="cursor:pointer;" border="0" onclick="change_status(<?php #echo $meeting->id;?>,'deactivate','pages');"><?php #} else { ?> <img src="public/admin/images/ico5.png" style="cursor:pointer;" border="0" onclick="change_status(<?php #echo $meeting->id;?>,'activate','pages');"> <?php #}?></span>-->
                    <span><a href="admin/invite_user/<?php echo $meeting->id; ?>" title="Invite to user(s)."><img src="public/admin/images/invite.png"/></a></span>&nbsp;
                    
					<span><a href="admin/event_details/<?php echo $meeting->id; ?>" title="View event  profile details."><img src="public/admin/images/view.png"/></a></span>
                    <span><a href="admin/edit_event/<?php echo $meeting->id; ?>" title="Click to edit event."><img src="public/admin/images/ico3.png"/></a></span>
                       <span><a class="button" title="Delete event profile."><img src="public/admin/images/ico7.png" width="15" height="15" hspace="5" vspace="2" align="absmiddle" onclick="scrollup('<?php echo $meeting->id; ?>')"/></a></span>
	...
	<div id="popupContact">
		...
		<p class="txt14">
			Are you sure you want to delete this event?</p>
